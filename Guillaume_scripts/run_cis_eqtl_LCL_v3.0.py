...
#covariates
covariate_data = pd.read_table(covariate_file,sep='\t',index_col=0)
...
for i in covariates:
	...
	genopheno.index.name = 'SampleID'
	genopheno.to_csv(outfolder+'/covariates_'+str(i+1)+'.txt',sep='\t',float_format='%.3f',index=True)
