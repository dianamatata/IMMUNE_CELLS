...
allCRDs = fread('/Users/dianaavalos/Programming/Hi-C_correlated_peaks_70/EGAD00001002672_ALL.modules.MOD1.NRE2.txt.gz',header=F)
...
mapdata = read.table('/Users/dianaavalos/Programming/Hi-C_correlated_peaks_70/mapping_gene_CRD_mean_ALL_72.txt',stringsAsFactors=F)
...
d = read.table("gene_CRD_mean_permutations_full.txt.gz", hea=F, stringsAsFactors=F)
...
cordata = fread('/Users/dianaavalos/Programming/Hi-C_correlated_peaks_70/EGAD00001002674_RNA.ALL.txt.gz')
