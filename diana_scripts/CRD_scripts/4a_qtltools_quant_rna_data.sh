...
IN=/home/users/a/avalosma/scratch/Blueprint/ref_files/gencode.v15.annotation.gtf.gzi
IN_BAM=i/home/users/a/avalosma/scratch/Blueprint/RNA_seq
...
sbatch -J $JOB\.job --partition=mono-EL7 --time=20:00:00 -o $OUT_FOLDER/OUT/$JOB.out -e $OUT_FOLDER/OUT/$JOB.err --wrap="$cmd"
