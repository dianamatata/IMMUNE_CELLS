...
covariate_file = 'methylomics/Donor_id_Sex.map'
...
# com1 = 'bsub -K -o '+outfolder+'/OUT/genotype_pca.out -e '+outfolder+'/ERR/genotype_pca.err -J genotype_pca -q
# priority \'~/bin/QTLtools1.1/bin/QTLtools pca --vcf '+vcf_file+' --scale --center --maf 0.05 --distance 50000 --out '+outfolder+'/genotype_pca\''
# print(com1)
# os.system(com1)
...
for i in covariates:
    ...
    for j in range(1, nchunks + 1):
        ...
        com3 = '\'/home/grey2/bin/QTLtools1.1/bin/QTLtools cis --normal --vcf ' + vcf_file + ' --bed ' + phenotype_matrix + ' --cov ' + outfolder + '/covariates_' + str(
...
for k in covariates:
    ...
    com5 = '/software/R/3.4.2/bin/Rscript /home/grey2/bin/QTLtools1.1/script/runFDR_cis.R ' + outfolder + '/permutations_cov' + str(
