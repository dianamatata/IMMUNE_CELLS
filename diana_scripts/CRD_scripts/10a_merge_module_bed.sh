...
# step 2
cat $DATADIR3/EGAD00001002672.ALLchr.module.merged.bed $DATADIR3/EGAD00001002673.ALLchr.module.merged.bed | sort -V -k1,1 -k2,2n > $DATADIR3/72_73.ALLchr.module.bed
cat $DATADIR3/EGAD00001002670.ALLchr.module.merged.bed $DATADIR3/EGAD00001002673.ALLchr.module.merged.bed | sort -V -k1,1 -k2,2n > $DATADIR3/70_73.ALLchr.module.bed
cat $DATADIR3/EGAD00001002670.ALLchr.module.merged.bed $DATADIR3/EGAD00001002672.ALLchr.module.merged.bed | sort -V -k1,1 -k2,2n > $DATADIR3/70_72.ALLchr.module.bed
